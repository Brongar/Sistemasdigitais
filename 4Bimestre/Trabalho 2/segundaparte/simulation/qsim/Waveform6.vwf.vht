...
-- *****************************************************************************
-- Generated on "12/02/2023 21:41:08"
...
SIGNAL entrada_top : STD_LOGIC;
SIGNAL reset_top : STD_LOGIC;
SIGNAL saida_teste : STD_LOGIC_VECTOR(15 DOWNTO 0);
COMPONENT toplevel
	PORT (
	botao_seletor : IN STD_LOGIC;
	clock_top : IN STD_LOGIC;
	entrada_top : IN STD_LOGIC;
	reset_top : IN STD_LOGIC;
	saida_teste : OUT STD_LOGIC_VECTOR(15 DOWNTO 0)
	);
END COMPONENT;
BEGIN
	i1 : toplevel
...
-- entrada_top
t_prcs_entrada_top: PROCESS
BEGIN
	entrada_top <= '0';
WAIT;
END PROCESS t_prcs_entrada_top;
